...
description: "Install patch.moi codex-toys automation templates into a workbench while keeping execution state in codex-toys."
---

# Install codex-toys Templates

Use this workflow when a workbench should receive patch.moi automation recipes
...
5. Verify `.codex/automations/patch-moi-maintain-fork` and
   `.codex/automations/patch-moi-feature-candidate` exist in the workbench.
