...
description: "Maintain a Git-first fork with patch.moi by inspecting remotes, remote-tracking upstream refs, patch branches, dry-run flow matches, and gated mutation policy before any write."
---
...
3. Use the dry-run tool that matches the update:
   - `run_codex_release_dry_run` for OpenAI Codex release tags.
   - `run_codex_main_dry_run` for upstream main branch movement.
