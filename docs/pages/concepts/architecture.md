...
- patch.moi may ship codex-flows automation templates as recipes.
...
| patch.moi | inspect, capture, rebuild, candidate ref listing, fast-forward pickup, reusable codex-flows templates |
